	...
	<?php
		...
		<?php $comment_args = array( 
			...
			'fields' => apply_filters( 'comment_form_default_fields', array(
				...
				'url'    => '</div>' ) ),
			'comment_notes_after' => '',
			'submit_button' => '<div class="column is-full"><div class="control"><input name="submit" type="submit" id="submit" class="button is-primary post-comment-button" value="Post" /></div></div></div>'
			);
